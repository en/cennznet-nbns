...
pub use cennznet_primitives::{
    AccountId, AccountIndex, AuthorityId, AuthoritySignature, Balance, BlockNumber,
    CennznetExtrinsic, Hash, Index, Signature,
};
...
use runtime_primitives::{
    ...
    traits::{
        self, AuthorityIdFor, BlakeTwo256, Block as BlockT, Checkable, Convert, DigestFor,
        NumberFor, StaticLookup,
    },
...
pub type CheckedExtrinsic =
    <<Block as BlockT>::Extrinsic as Checkable<system::ChainContext<Runtime>>>::Checked;
